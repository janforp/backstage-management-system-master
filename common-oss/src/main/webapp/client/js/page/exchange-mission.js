...
function turnPage(pageNum) {
    ...
    $.ajax({
        url: "/c/page/console/auth/exchange/listByPageNum",
        type: "POST",
        dataType: "JSON",
        data: {
            pageNum: pageNum
        ...
        success: function(data){
            if (data.success) {
                ...
                var exchangeUrl = data.bean.exchangeUrl;
                ...
                for (var i= 0;i<vos.length ;i ++) {
                    newTbody +=
                        ...
                        "   <td>"+vos[i].leftNum+"</td>"+
                        "   <td>"+exchangeUrl+vos[i].exchangeCode+"</td>"+
...
function deleteMission() {
    ...
    $.ajax({
        url: "/c/page/console/auth/exchange/deleteMission",
        type: "POST",
        dataType: "JSON",
        data: {
...
function updateMission() {
    ...
    window.location.href = ("/c/page/console/auth/exchange/updateMissionPage?missionId="+missionId);
}
 ...
 */
function addMission() {
    window.location.href = ("/c/page/console/auth/exchange/addMissionPage");
}
...
function showDetail() {
    ...
    var missionId = $input.val();
    window.location.href = ("/c/page/console/auth/exchange/missionDetailPage?missionId="+missionId);
}
...
function addNum() {
    ...
    $.ajax({
        url: "/c/page/console/auth/exchange/addNum",
        type: "POST",
        dataType: "JSON",
        data: {
            missionId: missionId,
...
function addMissionStep() {
    ...
    var missionId = $input.val();
    window.location.href = "/c/page/console/auth/exchange/addStepPage?missionId="+missionId;
}